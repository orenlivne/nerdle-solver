...
class TestScore:
    def test_score_cpp(self):
        ...
        assert sgo.score_guess(b"54/9=6",
                               b"4*7=28") == hints_to_score((Hint.ABSENT,
                                                             Hint.PRESENT,
                                                             Hint.ABSENT,
                                                             Hint.ABSENT,
                                                             Hint.PRESENT,
    ...
    def test_score_8slots(self):
        assert sgo.score_guess(b"10-43=66",
                               b"12+34=56") == hints_to_score((Hint.CORRECT,
                                                               Hint.ABSENT,
                                                               Hint.ABSENT,
                                                               Hint.PRESENT,
                                                               Hint.PRESENT,
        ...
        assert sgo.score_guess(b"10-84=46",
                               b"12+34=56") == hints_to_score((Hint.CORRECT,
                                                               Hint.ABSENT,
                                                               Hint.ABSENT,
                                                               Hint.ABSENT,
        ...
        assert sgo.score_guess(b"10-43=46",
                               b"12+34=56") == hints_to_score((Hint.CORRECT,
                                                               Hint.ABSENT,
                                                               Hint.ABSENT,
                                                               Hint.PRESENT,
        ...
        # Repeated digit where second occurrence is the correct one. First one
        # should be ABSENT then.
        assert sgo.score_guess(b"40-84=77",
                               b"12+34=56") == hints_to_score((Hint.ABSENT,
                                                               Hint.ABSENT,
                                                               Hint.ABSENT,
                                                               Hint.ABSENT,
                                                               Hint.CORRECT,
